...
const contactInfo = [
  { id: 1, label: "Phone", value: "+923241441444", icon: "fas fa-envelope" },
  {
    id: 2,
    label: "Mail",
    value: "webiasolutionz@gmail.com",
...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (
      ...
      emailjs
        .send(
          "service_ur4gkz2", // service id
          "template_qlkj8ht", // template id
          mailData,
          "Ybm-Gr66ask2Cc94H" // public api
        )
        .then(
          (response) => {
            setError(false);
